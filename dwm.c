...
enum { SchemeNorm, SchemeSel, SchemeTitle, SchemeScratchNorm, SchemeScratchSel }; /* color schemes */
enum { NetSupported, NetSystemTray, NetSystemTrayOP, NetSystemTrayOrientation, NetSystemTrayVisual,
	   ...
	   NetSystemTrayOrientationHorz, NetWMWindowTypeDialog, NetClientList, NetClientListStacking, NetWMCheck, NetDesktopNames, NetDesktopViewport, NetNumberOfDesktops, NetCurrentDesktop, NetLast }; /* EWMH atoms */
